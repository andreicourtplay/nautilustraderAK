...
- `strategies/single_symbol_entry.py`: pure decision logic.
- `scripts/run_minimal_strategy.py`: IBKR/TWS runner.

Default behavior is safe: the runner sends `whatIf` only unless both
`--submit-paper-order` and `--confirm-paper-trade` are present.
